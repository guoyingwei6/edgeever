...
export const zhCN = {
  ...
  systemInfo: {
    ...
    desktopUpdateAvailableTitle: "发现客户端新版本",
    desktopUpdateAvailableDescription: "新版本已可下载并安装。",
    desktopUpdateReadyTitle: "客户端更新已就绪",
    desktopUpdateReadyDescription: "重启 EdgeEver 以完成更新。",
