...
export const enUS = {
  ...
  systemInfo: {
    ...
    desktopUpdateAvailableTitle: "Client update available",
    desktopUpdateAvailableDescription: "A new version is ready to download and install.",
    desktopUpdateReadyTitle: "Client update ready",
    desktopUpdateReadyDescription: "Restart EdgeEver to finish updating.",
